...
const {registerAccount, getAccountByEmail, updateAccount, updatePassword, getAccountByID} = require('../models/account-model')
...
accCont.buildManagement = async function (req, res, next) {
  let nav = await utilities.getNav()
...
//build the edit account page

accCont.editAccount = async function (req, res) {
  let nav = await utilities.getNav()
...
accCont.updateAccount = async function (req, res) {
  ...
  if(account_password) {
    ...
    const regResult = await updatePassword(
      hashedPassword,
      account_id
    )
    if (regResult) {
    ...
    const regResult = await updateAccount(
      account_firstname,
      account_lastname,
      account_email,
      account_id
